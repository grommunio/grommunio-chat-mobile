...
import com.grommunio.helpers.RealPathUtil;
import com.grommunio.share.ShareModule;
...
import com.grommunio.flipper.ReactNativeFlipper;
          ...
          new TurboReactPackage() {
                ...
                public ReactModuleInfoProvider getReactModuleInfoProvider() {
                  return () -> {
                    ...
                    map.put("MattermostManaged", new ReactModuleInfo("MattermostManaged", "com.grommunio.rnbeta.MattermostManagedModule", false, false, false, false, false));
                    map.put("MattermostShare", new ReactModuleInfo("MattermostShare", "com.grommunio.share.ShareModule", false, false, true, false, false));
                    map.put("Notifications", new ReactModuleInfo("Notifications", "com.grommunio.rnbeta.NotificationsModule", false, false, false, false, false));
                    map.put("SplitView", new ReactModuleInfo("SplitView", "com.grommunio.rnbeta.SplitViewModule", false, false, false, false, false));
                    return map;
                  };
                }
              }
