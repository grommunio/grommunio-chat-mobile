...
const prepackagedPlugins = new Set([
    'antivirus',
    'mattermost-autolink',
    'com.grommunio.aws-sns',
    'com.grommunio.plugin-channel-export',
    'com.grommunio.custom-attributes',
    'github',
    'com.github.manland.mattermost-plugin-gitlab',
    'com.grommunio.plugin-incident-management',
    'jenkins',
    'jira',
    'com.grommunio.calls',
    'com.grommunio.nps',
    'com.grommunio.welcomebot',
    'zoom',
]);
